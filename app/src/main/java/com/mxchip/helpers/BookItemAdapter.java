...
import com.mxchip.activities.ibake.DevCtrlActivity;
import com.mxchip.activities.ibake.MyDeviceEditActivity;
...
//    private String TAG = "---BookItemAdapter---";
    ...
    public BookItemAdapter(Activity context, ListView listView) {
