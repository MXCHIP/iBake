...
public class DecodeHandler extends Handler {
	...
	public DecodeHandler(MiCOQrCodeActivity activity,
	...
	public void handleMessage(Message message) {
		...
		switch (message.what) {
		case ComminuteCode.DECODE:
			decode((byte[]) message.obj, message.arg1, message.arg2);
			break;
		case ComminuteCode.QUITE:
			running = false;
		...
		if (rawResult != null) {
			...
			if (handler != null) {
				Message message = Message.obtain(handler,
						ComminuteCode.SUCCEEDED, rawResult);
			...
			if (handler != null) {
				Message message = Message.obtain(handler, ComminuteCode.FAILED);
				message.sendToTarget();
			}
		}
