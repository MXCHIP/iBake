...
public final class WifiApManager {
    ...
    public WifiApManager(Context context) throws SecurityException, NoSuchMethodException {
        ...
        wifiApConfigurationMethod = mWifiManager.getClass().getMethod("getWifiApConfiguration",new Class[0]);
    ...
    {
        try{
            return (WifiConfiguration)wifiApConfigurationMethod.invoke(mWifiManager, new Object());
        }
        catch(Exception e)
        {
            return null;
